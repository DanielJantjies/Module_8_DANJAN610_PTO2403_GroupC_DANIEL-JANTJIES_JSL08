...
const branchA = new BankBranch({ name: "First Branch", address: "444 Dorchester Street"});
const branchB = new BankBranch({ name: "Second Branch", address: "333 Parliament Street"});
